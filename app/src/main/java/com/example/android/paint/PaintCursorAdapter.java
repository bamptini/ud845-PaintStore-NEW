...
public class PaintCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, final Context context, final Cursor cursor) {
        ...
        paintSoldButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // NEWLY ADDED // Added tempInt it works butht elist view is still plus 1
                int tempInt = Integer.parseInt(paintQuantity) -1;
                ...
                ////////////NEWLY ADDDED //////////// Changed line below to line below below
                    //subtractStock(context, id, Integer.parseInt(paintQuantity));
                subtractStock(context, id, tempInt);
    ...
    private void subtractStock(Context context, long id, int quantity) {
        ...
        if(quantity == 0){
            Toast.makeText(context, "Sell failed. Quantity is already 0", Toast.LENGTH_LONG).show();
            return;
        }
